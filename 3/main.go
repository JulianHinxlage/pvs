...
var changeActiveChannel1 = make(chan string, 4)
var changeActiveChannel2 = make(chan string, 4)
var changeActiveChannel3 = make(chan string, 4)
var changeActiveChannel4 = make(chan string, 4)

var changePhaseChannel1 = make(chan string, 10)
var changePhaseChannel2 = make(chan string, 10)
